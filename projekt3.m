...
% konfiguracja 1
% sworzenie pustego obrazka
Im = uint8(zeros(Y, X));

% narysowanie kazdego trójkąta z modelem oświetlenia Lamberta n jednym obrazku
[Im,~] = tr_Lambert(Im, r1, r2, r3, Amb, p_light, Imax, X, Y, dx, dy, col_A); % trojkat czerwony
[Im,~] = tr_Lambert(Im, r1, r4, r3, Amb, p_light, Imax, X, Y, dx, dy, col_B); % trojkat zielony
[Im,~] = tr_Lambert(Im, r2, r4, r3, Amb, p_light, Imax, X, Y, dx, dy,  col_C); % trojkat niebieski
...
[Im1, Ish1] = tr_Lambert(Im, r1, r2, r3, Amb, p_light, Imax, X, Y, dx, dy, col_A); % czerwony
[Im2, Ish2] = tr_Lambert(Im, r1, r4, r3, Amb, p_light, Imax, X, Y, dx, dy, col_B); % zielony
[Im3, Ish3] = tr_Lambert(Im, r2_reshaped, r4_reshaped, r3_reshaped, Amb, p_light, Imax, X, Y, dx, dy, col_C); % niebieski
...
figure(2); imshow(FImR);

%% część 2

numFrames = 250;
video = VideoWriter('animacja10.avi');
open(video);
